...
print('''    Volume in IFNE-HD is IFNE_DISK
     Directory of IFNE-HD:\
''') ; sleep(1.5)
print('''
...
''') ; sleep(1)
slowprint('''    IFNE  SYS*        4   7-11-95   9:50a
...
print('''    Volume in drive IFN-HD is DISK13
    ...
    IFNE_13 CAB    981813   7-11-95   9:50a
...
print('''
      your decrypted message is : ''',encrypted_text)   
print('''
